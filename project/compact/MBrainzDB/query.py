...
if __name__ == '__main__':
    ...
    if sys.argv[1] == '-hdf5':
        ...
        print('has musicbrainz id for'+cntmbid+'out of'+str(len(paths)))
        print('found years for'+cntyears+'out of'+str(len(paths)))
        print('found tags for'+cnttags+'out of'+str(len(paths)))
